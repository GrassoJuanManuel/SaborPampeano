// Código Backend (Google Apps Script) - VERSIÓN 21
...
function mostrarLink() {
  ...
  if (urlGuardada) {
    var html = '<div style="font-family:Arial,sans-serif;padding:15px;text-align:center;">'
      ...
      +'<a href="#" onclick="google.script.run.withSuccessHandler(function(){google.script.host.close();}).borrarLink();" style="font-size:10px;color:#999;text-decoration:underline;">Modificar link</a>'
